...
#from model.MySQLFile import insertquery, create_query
    ...
    try:
        ...
        if main_op_id != None:
            ...
            for ld in list_data:
                ...
                if "|" in bot_resp:
                    ...
                    category_ins = str(ld[6])
                    data = json.dumps(json_data)
                    print("json data = ", data)
                    dbInsertion(temtext, data, "answered", username, userType, userID, "-1", mainIssue, category_ins, "-1",Location)
                    resp = flask.Response(encrypt(data))
                    # resp = flask.Response(data)
        ...
        if operation_id != None:
            ...
            query_data = create_query(
                "select response,HINT_TEXT,Benefits_Type from operations_MyTaj where op_id = '" + str(operation_id) + "' ")
            ...
            data = json.dumps(json_data)
            print("json data = ", data)
            dbInsertion(temtext, data, "answered", username, userType, userID, "-1", mainIssue, benefitType, "-1",Location)
        ...
        if Sub_Benefits_id != None:
            ...
            query_data = create_query(
                "select op_id,HINT_TEXT,Sub_Benefits_Type,Benefits_Type from operations_MyTaj where Sub_Benefits_id = '" + Sub_Benefits_id + "' AND Location_id ='" + location_id + "' ")
            list_data = list(query_data)
            sub_benefits = ""
            benefitType = list_data[0][3]
            ...
            if (len(list_data)) > 0:
                ...
                json_data = {
                    "message": "I would be happy to tell you more. What would you like to know about <b>" + str(
                        sub_benefits) + "</b>",
                    "action": json_array,
                    "typetext": "HR",
                    "ParameterTitle": "ListView",
        ...
        if usertext.lower() == "":
            ...
            if "help" in str(temtext).lower():
                json_data = {
                    "error": "Sure, can you please enter the concern your are facing.",
                    "operation_id": "",
                    "response": "Sure, can you please enter the concern your are facing.",
                    "userText": temtext,
                    "title": "",
                    "cat1": "Greeting",
                    "cat2": "",
                ...
                data = json.dumps(json_data)
                print("json data = ", data)
                dbInsertion(temtext, data, "answered", username, userType, userID, "-1", mainIssue, "Greetings", "-1",Location)
                resp = flask.Response(encrypt(data))
                # resp = flask.Response(data)
            ...
            # usertext is empty hence taking original text through temtext
                ...
                json_data = {
                    "error": "I am sorry I could not resolve your concern.Would you like to send a mail to Help Desk Team? ",
                    "operation_id": "",
                    "response": "I am sorry I could not resolve your concern.Would you like to send a mail to Help Desk Team?",
                    "userText": temtext,
                    "title": "",
                    "cat1": "Greeting",
                    "cat2": "",
                ...
                data = json.dumps(json_data)
                print("json data = ", data)
                dbInsertion(temtext, data, "unanswered", username, userType, userID, "-1", mainIssue, "Greetings", "-1",Location)
                resp = flask.Response(encrypt(data))
                # resp = flask.Response(data)
                ...
                for t_list in tag_list:
                    ...
                    if len(t_list) == 4:
                        ...
                        if locationId.upper() == Location:
                            ...
                            category = t_list[4]
                            print("select benefit type----->",category)
                ...
                if lastFlag:
                    if len(json_data) > 0:
                        ...
                        json_data = {
                            ...
                            "cat2": "HR",
                            "cat3": "Queries",
                            "error": "I am sorry, we could not find a solution for your reported concern. Would you like to raise a ticket to the Help Desk Team?",
                            "mainIssue": mainIssue,
                            "project_name": "Service Request",
                            "rating": "err",
                            "resolve": ""
...
def get_issue_ticket():
    try:
        ...
        orignalText = objectrecived.get('orignalText')
